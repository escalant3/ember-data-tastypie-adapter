...
DS.DjangoTastypieSerializer = DS.Serializer.extend({
  ...
  getItemUrl: function(meta, id){
    ...
    return ["", get(this, 'tastypieApiUrl').slice(0,-1), url, id, ""].join('/');
  },
...
DS.DjangoTastypieAdapter = DS.RESTAdapter.extend({
  ...
  init: function() {
    ...
    tastypieApiUrl = get(this, 'tastypieApiUrl');
    Em.assert("tastypieApiUrl parameter is mandatory.", !!tastypieApiUrl);

    // Make the adapter available for the serializer
    serializer = get(this, 'serializer');
    set(serializer, 'adapter', this);
    set(serializer, 'tastypieApiUrl', tastypieApiUrl);
  },
  ...
  getTastypieUrl: function(url){
    Em.assert("tastypieApiUrl parameter is mandatory.", !!this.tastypieApiUrl);
